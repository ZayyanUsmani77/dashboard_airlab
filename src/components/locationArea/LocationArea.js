        ...
        <div className="banner-location-flex">
          <div className="banner-location-single">
            <div className="banner-location-single-flex">
              <div className="banner-location-single-icon" style={{marginTop:'30px'}}>
          ...
          <div className="banner-location-single">
            <div className="banner-location-single-flex">
              ...
              <div className="banner-location-single-contents">
                <span className="banner-location-single-contents-subtitle"> Start </span>
                ...
                <input
                        ...
                        id="colFormLabel"
                        value="2022-07-22"
                    style={{width:'100%',height:'55px',border:'1px solid #E8E8E8',borderRadius:'4px'}}/>                </div>
              </div>
            </div>
          </div>
          <div className="banner-location-single">
            <div className="banner-location-single-flex">
              ...
              <div className="banner-location-single-contents">
                <span className="banner-location-single-contents-subtitle"> Completion </span>
                <div className="banner-location-single-contents-dropdown custom-select">
                <input
                        type="date"
                        className="form-control"
                        id="colFormLabel"
                        value="2022-11-13"
                    style={{width:'100%',height:'55px',border:'1px solid #E8E8E8',borderRadius:'4px'}}/>  
                </div>
              </div>
            </div>
          </div>
          <div className="banner-location-single">
            <div className="banner-location-single-flex">
              ...
              <div className="banner-location-single-contents">
                <span className="banner-location-single-contents-subtitle"> Lab Category </span>
                <div className="banner-location-single-contents-dropdown custom-select">
                  <select className="js-select select-style-two" name="state">
          ...
          <div className="banner-location-single">
            <div className="banner-location-single-flex">
              <div className="banner-location-single-icon" style={{marginTop:'30px'}}>
              <i class="las la-vials"/>
              </div>
              <div className="banner-location-single-contents">
                <span className="banner-location-single-contents-subtitle"> Services </span>
                <div className="banner-location-single-contents-dropdown custom-select">
                  <select className="js-select select-style-two" name="state">
          ...
          <div className="banner-location-single-search">
            <div className="search-suggestions-wrapper">
              <div className="search-click-icon" style={{backgroundColor:'#2741f7'}}>
              <Link to="/filter" style={{color:'white'}}><i className="las la-search" /></Link>
              </div>
