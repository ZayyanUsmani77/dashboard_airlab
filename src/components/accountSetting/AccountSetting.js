        ...
        <div className="row">
            ...
            <div className="card service-wrapper rounded border-0 shadow p-4">
              ...
              <div className="content mt-4">
                ...
                <p className="  mt-3 mb-0">
                  It is a long established fact that a reader will be distracted by the when looking
                  at its layout.
                </p>
                <div className="mt-3">
              ...
              <div className="icon text-center text-custom h1 shadow rounded bg-white">
                <span className="uim-svg" style={{}}>
                  ...
                  >
                    ...
                    />
                    <circle cx={7} cy={17} r={5} className="uim-primary" />
                    <path
          ...
          <div className="col-lg-4 col-md-6 col-12 mt-4 pt-2">
            <div className="card service-wrapper rounded border-0 shadow p-4">
              <div className="icon text-center text-custom h1 shadow rounded bg-white">
                <span className="uim-svg" style={{}}>
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="1em">
                    ...
                    />
                    <polygon className="uim-primary" points="20 14 20 21 4 17 4 14 20 14" />
                    <path
                      className="uim-primary"
              ...
              <div className="content mt-4">
                <h5 className="title">Billings</h5>
                <p className="  mt-3 mb-0">
                  It is a long established fact that a reader will be distracted by the when looking
                  at its layout.
                </p>
              ...
              <div className="icon text-center text-custom h1 shadow rounded bg-white">
                <span className="uim-svg" style={{}}>
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="1em">
                    ...
                    />
                    <polygon className="uim-primary" points="21 12 16 7 16 17 21 12" />
                    <path
                      className="uim-primary"
