...
const SecondCard = (props) => {
  ...
  return (
    <>
    <div class="card carda" style={{width: '22rem', height:'520px',padding:'0px',marginBottom:'10px',marginTop:'14px',borderRadius:'15px',boxShadow: 'rgba(0, 0, 0, 0.29) 0px 5px 15px'}}>
  ...
  <div class="row" >
    <div class="col" style={{textAlign:'left'}}>
      <div style={{width:'80px',height:'32px',float:'left',borderRadius:'6px',backgroundColor:'yellow',textAlign:'center',paddingTop:'6px'}}><button style={{border:'none',textAlign:'center',backgroundColor:'yellow',color:'black'}}>Featured</button></div>
    </div>
    <div class="col"style={{textAlign:'right', paddingRight:'0px'}}>
     <div >
        ...
        <br/>
        <button className='btn3' style={{marginTop:'150px',width:'120px',borderRadius:'20px',height:'50px',backgroundColor:'rgba(103, 128, 159, 0.6',border:'none',color:'white'}}>{props.banner}</button>
     </div>
    </div>
  </div>
  ...
  <div className="card-body">
    <div
      ...
      style={{}}
    >
      <h4>Visit Our Lab</h4 ><h5 style={{color:'#2741f7'}}>  <div
                        style={{
                      ...
                      >
                        <i class="las la-certificate"></i> Verified space
                      </div></h5>
    </div>
